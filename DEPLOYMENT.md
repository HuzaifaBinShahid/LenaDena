...
Create one project, then apply every SQL file under `supabase/migrations/` in filename order. Configure Auth URL settings with `lenadena://` as an allowed redirect URL.
