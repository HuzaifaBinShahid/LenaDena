    ...
    <Screen>
      ...
      {!isResolving && image?.contentUri ? (
        <View className="gap-6">
          ...
          <View className="rounded-card bg-mint-soft p-5">
            ...
            <Text className="mt-2 text-sm leading-5 text-slate">OweYaar does not receive the WhatsApp chat, contact list, or conversation name. Nothing is uploaded until you save the reviewed expense.</Text>
          </View>
      ...
      {!isResolving && !image ? (
        <View className="rounded-card border border-line bg-raised p-6">
          ...
          <Text className="mt-2 text-sm leading-5 text-slate">Open a receipt in WhatsApp, tap Share, and choose OweYaar. You can also choose a receipt from Add expense.</Text>
